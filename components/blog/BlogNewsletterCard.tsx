...
export default function BlogNewsletterCard() {
    return (
        <div className="bg-burgundy text-white rounded-[2rem] p-8 md:p-10 shadow-lg text-center">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <button
                    type="submit"
                    className="w-full rounded-full py-3.5 text-sm md:text-base font-semibold bg-[#8B9F8B] hover:bg-[#A3B5A3] text-white transition-colors duration-300"
                >
                    Join the Sanctuary
                </button>
            </form>
