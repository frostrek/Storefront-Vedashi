            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="flex flex-col justify-center max-w-xl animate-fade-in-up md:pl-8">
                        <div className="mb-6">
                            <span className="inline-block border border-vedic-gold/30 text-vedic-gold font-semibold uppercase tracking-widest text-[10px] sm:text-xs px-4 py-1.5 rounded-full mb-4">
                                Featured Wisdom
                            </span>
                        </div>
