            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="relative h-[400px] md:h-[500px] lg:h-[600px] w-full max-w-2xl mx-auto lg:mx-0">
                        ...
                        <div className="absolute left-1/4 top-1/4 w-1/2 h-1/2 bg-wine-gold/20 blur-[80px] rounded-full z-0" />
                    </div>
                    
                    {/* Right: Featured Content */}
                    <div className="flex flex-col justify-center max-w-xl animate-fade-in-up md:pl-8">
                        <div className="mb-6">
                            <span className="inline-block border border-wine-gold/30 text-wine-gold font-semibold uppercase tracking-widest text-[10px] sm:text-xs px-4 py-1.5 rounded-full mb-4">
                                Featured Wisdom
                            </span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-6">
                            ...
                            <div className="flex items-center text-sm text-warm-gray font-medium">
                                <svg className="w-5 h-5 mr-2 text-wine-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
