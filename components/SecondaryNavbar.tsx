    ...
    <div className="hidden md:block bg-white border-b border-gray-200 shadow-sm relative z-[90]">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6">
        <div className="flex h-[46px] items-center justify-between text-[14px] font-bold text-gray-700">
          ...
          <div className="flex items-center gap-4 h-full overflow-x-auto no-scrollbar scroll-smooth">
              ...
              return (
                <div key={parent.category_id} className="group/nav-item h-full flex items-center shrink-0">
                  <Link 
                    ...
                    className="flex items-center gap-1 h-full px-2 hover:text-[#3B5D3B] transition-colors cursor-pointer border-b-2 border-transparent group-hover/nav-item:border-[#3B5D3B]"
                  >
                    {parent.name}
                  </Link>
                  ...
                  {subcats.length > 0 && (
                    <div className="absolute top-full left-0 w-full bg-white shadow-[0_10px_40px_rgba(0,0,0,0.1)] opacity-0 invisible group-hover/nav-item:opacity-100 group-hover/nav-item:visible transition-all duration-300 z-[100] border-t-[3px] border-[#3B5D3B]">
                      <div className="mx-auto max-w-[1400px] px-8 py-8 flex gap-8 min-h-[250px]">
            ...
            <div className="group/nav-item h-full flex items-center shrink-0">
              <span className="flex items-center gap-1 h-full px-2 text-[#3B5D3B] transition-colors cursor-pointer border-b-2 border-transparent group-hover/nav-item:border-[#3B5D3B]">
                Brands A-Z
              </span>
              ...
              {!loading && brands.length > 0 && (
                <div className="absolute top-full left-0 w-full bg-white shadow-[0_10px_40px_rgba(0,0,0,0.1)] opacity-0 invisible group-hover/nav-item:opacity-100 group-hover/nav-item:visible transition-all duration-300 z-[100] border-t-[3px] border-[#3B5D3B]">
                  <div className="mx-auto max-w-[1400px] px-8 py-8 max-h-[450px] overflow-y-auto w-full">
          ...
          <div className="flex items-center gap-6 h-full text-[13px] font-bold tracking-wide shrink-0 ml-4">
             <Link href="/offers" className="text-red-600 hover:text-red-700 h-full flex items-center italic">Offers</Link>
