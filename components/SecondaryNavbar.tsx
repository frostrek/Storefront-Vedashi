...
export default function SecondaryNavbar() {
  ...
  return (
    <div className="hidden md:block bg-black relative z-[90]">
      <div className="mx-auto max-w-[1500px] px-4 sm:px-6 lg:px-8">
        <div className="flex h-[32px] items-center justify-between text-[14px] uppercase font-bold text-white font-sans">
          ...
          <div className="flex items-center gap-0 h-full overflow-x-auto no-scrollbar scroll-smooth">
            ...
            {!loading && parentCategories.length > 0 && (
              <div className="h-4 w-[1px] bg-white/20 self-center shrink-0 mx-2" />
            )}
          ...
          <div className="flex items-center h-full text-[13px] font-bold tracking-wide shrink-0 ml-4">
            <div className="h-4 w-[1px] bg-white/20 self-center mx-3" />
            <Link href={`/${country}/products?bestSeller=true`} className="text-white hover:text-[#91CA35] h-full flex items-center">Best Sellers</Link>
            <div className="h-4 w-[1px] bg-white/20 self-center mx-3" />
