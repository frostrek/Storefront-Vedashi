...
interface AuthContextType {
    ...
    isLoading: boolean;
    login: (email: string, password: string, turnstileToken?: string | null) => Promise<{ success: boolean; error?: string; code?: string; role?: string; access_token?: string; requireCaptcha?: boolean; blocked?: boolean; retryAfter?: number }>;
