...
function LoginContent() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white overflow-y-auto">
            <div className="flex-1 flex flex-col justify-center py-12 px-6 sm:px-12 relative">
                {/* Back Button */}
                <button
                    onClick={() => router.back()}
                                    ...
                                    {!isRegister && (
                                        <div className="flex justify-between items-center mt-3 mb-1">
                                            <label className="flex items-center gap-2 cursor-pointer group">
                                                ...
                                                <span className="text-sm font-medium text-gray-600 group-hover:text-gray-700 transition-colors select-none">Remember Me</span>
                                                <input
                                                    type="checkbox"
                                                    checked={rememberMe}
                                ...
                                <div className="mt-1 pt-5 border-t border-[#e8f0e8]">
                                    ...
                                    {!isRegister && (
                                        <div className="flex items-center justify-center gap-3 mb-5">
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => window.dispatchEvent(new CustomEvent('trigger-social-login', { detail: 'facebook' }))}
                                                disabled={loading}
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => window.dispatchEvent(new CustomEvent('trigger-social-login', { detail: 'apple' }))}
                                                disabled={loading}
