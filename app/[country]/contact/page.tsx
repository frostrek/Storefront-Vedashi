...
export default function ContactPage() {
    ...
    return (
        <div className="relative min-h-screen bg-[#F6F7F4] overflow-hidden selection:bg-[#5F6F52] selection:text-white pb-24">
            ...
            <motion.div 
                ...
                style={{ willChange: "transform, opacity" }}
                className="absolute top-[20%] right-[-15%] w-[800px] h-[1000px] pointer-events-none z-0"
            >
                <Image
            ...
            >
                <motion.div 
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-gray-300 bg-white/50 px-5 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#5F6F52] mb-6 backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow cursor-default"
                >
                    Get In Touch
                </motion.div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="pt-2">
                                <motion.button
                                    ...
                                    type="submit"
                                    disabled={isSubmitting}
                                    className="inline-flex items-center gap-2 rounded-xl bg-[#677659] px-7 py-3.5 text-[15px] font-semibold text-white hover:bg-[#536148] transition-colors disabled:opacity-70 disabled:cursor-not-allowed shadow-[0_4px_12px_rgb(95,111,82,0.2)] hover:shadow-[0_8px_16px_rgb(95,111,82,0.3)]"
                                >
                        ...
                        >
                           {/* Decorative subtle texture/gradient */}
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="font-serif text-2xl font-bold text-white mb-2">Private Tasting Sessions</h3>
